...
wait.until(lambda x: x.find_element(AppiumBy.ID, "com.google.android.apps.photos:id/auto_backup_switch"))
driver.find_element(AppiumBy.ID, "com.google.android.apps.photos:id/auto_backup_switch").click()
wait.until(lambda x: x.find_element(AppiumBy.ID, "com.google.android.apps.photos:id/touch_outside"))
driver.find_element(AppiumBy.ID, "com.google.android.apps.photos:id/touch_outside").click()
wait.until(lambda x: x.find_element(AppiumBy.XPATH, "//*[@text='Keep off']"))
driver.find_element(AppiumBy.XPATH, "//*[@text='Keep off']").click()
time.sleep(5)
...
print(remote_path)
driver.push_file(remote_path, source_path=r'/Users/deepthigumpula/appium3/Test/test.png')
time.sleep(20)
...
time.sleep(10)
driver.find_element(AppiumBy.ID, "com.google.android.apps.photos:id/details").click()
time.sleep(10)
path= driver.find_element(AppiumBy.ID, "com.google.android.apps.photos:id/label").text
head_tail = os.path.split(path)

# print tail part of the path
assert(head_tail[1]) == "test.png"
driver.orientation = "PORTRAIT"
print("Test completed")
time.sleep(5)
driver.start_activity("com.google.android.gm", "com.google.android.gm.GmailActivity");
time.sleep(15)
if driver.find_element(AppiumBy.XPATH, "//*[@text='SKIP']"):
    driver.find_element(AppiumBy.XPATH, "//*[@text='SKIP']").click()
time.sleep(5)
...
time.sleep(5)
driver.find_element(AppiumBy.XPATH, "//*[@text='Google']").click()
